...
require (
	...
	go.opentelemetry.io/otel/log/logtest v0.0.0-20250526073304-9f282a1e1db1 // indirect
	go.opentelemetry.io/otel/sdk/log/logtest v0.0.0-20250526073304-9f282a1e1db1 // indirect
